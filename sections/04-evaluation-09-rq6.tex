...
Section~\ref{sec:project-level-exclusions-extended} covers project-level exclusions.
Section~\ref{sec:test-assertion-generalization-exclusions-extended} examines
