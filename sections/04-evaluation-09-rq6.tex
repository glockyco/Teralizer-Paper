...
and identifying which barriers prevent fully automated generalization.
...
\rqanswerbox{6}{
  ...
  and projects that pass early filtering proceed successfully through specification extraction (90.0\%) and generalized test creation (97.4\%).
  However, three primary barriers prevent higher success rates of the generalization pipeline:
  limited type and assertion pattern support causes 99.4\% of assertions to be filtered before reaching test generation
  ...
  and mutation testing timeouts cause 14.1\% of projects to be excluded.
}
