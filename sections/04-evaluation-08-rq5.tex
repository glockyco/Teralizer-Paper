\subsection{RQ5: What are the causes of unsuccessful generalization attempts?}
...
First, we analyze the primary evaluation dataset
consisting of \DatasetsEqBenchEs{} and \DatasetsCommons{} projects
which represents controlled conditions:
...
revealing additional challenges that emerge in practical application scenarios.
% The contrast between these datasets
% (from approximately 50\% success in controlled conditions
...
to establish a baseline of exclusion patterns under controlled conditions.
...
The three-level filtering cascade reveals that even under controlled conditions,
...
These findings establish that even under controlled conditions,
...
\input{tables/tab-exclusions-breakdown-extended.tex}
