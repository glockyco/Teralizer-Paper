...
(as previously explained in Section~\ref{sec:experimental-framework}).
In RQ6, we then present the results under real-world conditions, i.e., for the RepoReapers projects,
which reveal additional challenges that emerge in practical application scenarios.
...
are genuinely assertion-free tests that simply pass if no exception occurs during test execution.
