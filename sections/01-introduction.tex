...
By using \ToolSPFLong{}'s (\ToolSPF{}) constraint collection mode~\cite{pasareanu2013symbolic},
...
Among the 42\% of projects that build successfully (a prerequisite for any testing approach),
our pipeline completes for 2.1\% of projects.
This systematic analysis identifies which technical advances would enable broader deployment:
improved static analysis for method resolution (24.7\% of technical failures),
support for non-numeric types (15.4--49.4\% of exclusions),
...
\ToolTeralizer{} automatically extracts exact specifications through single-path symbolic analysis.
