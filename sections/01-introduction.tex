...
Results from the RepoReapers projects revealed practical applicability barriers:
...
We analyze test generalization barriers,
distinguishing engineering limitations
(e.g., identifying tested methods in complex control flow)
