...
Our semantics-based test generalization approach extracts path-exact specifications
from implementations and uses them to transform conventional unit tests into property-based tests.
This section describes \ToolTeralizer{}, our prototype implementation that demonstrates
the approach through a three-phase pipeline.
...
Our current implementation operates on Java 5--8 projects (limited by \ToolSPF{})
...
\begin{itemize}
    ...
    to study the mutation detection effectiveness and runtime efficiency
...
To understand the impact of these limitations,
...
enabling analysis of how constraint complexity affects generation effectiveness
...
that our current implementation cannot handle.
