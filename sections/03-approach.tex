...
as well as the path condition that needs to be satisfied to reach the execution path.
Because only a single execution path is exercised
...
as the type of the thrown exception is guaranteed to be identical
