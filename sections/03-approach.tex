...
The extracted specifications serve
...
The specifications can then be used
in the test transformation phase (Section~\ref{sec:test-transformation})
to create input value generators and generalized test oracles for property-based testing.
