...
by systematically injecting faults into the code and measuring whether tests detect them~\cite{jia_2011_analysis}.
A test suite that detects more mutants demonstrates stronger fault-finding capability.
We use \ToolPit{}~\cite{coles_2016_pit} with its DEFAULTS mutation operator group,
...
the RepoReapers projects expose fundamental barriers to practical applicability
analyzed in RQ5 (Section~\ref{sec:filtering-eval-extended}).
