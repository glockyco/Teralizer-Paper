...
but also enables a fairer comparison across strategies.
This is because it avoids non-deterministic failures such as \texttt{OutOfMemoryError}s
from affecting one generalized test suite variant more strongly than another.
The used \tries{} settings of 10, 50, and 200 were selected based on our own testing
...
expose the full spectrum of practical applicability challenges.
Table~\ref{tab:dataset-statistics} provides a high-level overview of these datasets
...
(e.g., sustained development over longer periods of time,
use of software testing and issue tracking,
availability of documentation, etc.).
...
which we analyze in RQ5 (Section~\ref{sec:limitations-eval}).
