...
which covers common fault patterns including arithmetic mistakes,
boundary errors, and incorrect boolean logic.
Table~\ref{tab:pit-mutators} describes these operators,
which range from simple arithmetic replacements to complex conditional modifications.
Understanding these operators is essential for interpreting our results,
particularly how different mutation types interact with our generalization strategies.
...
\begin{itemize}
  ...
  \item \VariantNaive{A/B/C}: Random generation with constraint filtering (10/50/200 \tries{}, where
    \tries{} specifies how many random inputs jqwik generates per property test)
  \item \VariantImproved{A/B/C}: Constraint-aware generation (10/50/200 \tries{})
\end{itemize}
