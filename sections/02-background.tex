...
However, adoption remains limited in practice~\cite{paiva_2022_pbt_survey}.
...
Unlike full symbolic execution, which faces path explosion when exploring all possible paths,
...
without the exponential complexity of exploring alternative branches.
