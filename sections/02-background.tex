...
to testing properties that should hold for entire classes of inputs~\cite{claessen_2000_quickcheck}.
...
For Java, jqwik~\cite{link_2022_jqwik} provides comprehensive property-based testing capabilities.
...
creates a significant barrier to adoption~\cite{barr_2015_oracle}.
...
This approach leverages symbolic state tracking from concolic execution~\cite{sen_2005_cute,godefroid_2005_dart}
...
that challenges full symbolic execution~\cite{pasareanu_2013_symbolic}
