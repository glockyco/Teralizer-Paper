...
using test-method mapping (Algorithm~\ref{alg:test-method-mapping}).
...
identified by existing tests using constraint-aware generation
(Algorithm~\ref{alg:constraint-encoding}).
...
accurately reflect the implementation through constraint-aware input generation
(Algorithm~\ref{alg:constraint-encoding}).
