...
achieving 40--80\% mutation scores on Java projects~\cite{fraser_2013_evosuite}.
...
(e.g., intervals \texttt{x ∈ [a,b]}, equalities \texttt{x = c}, linear relations \texttt{|x-y| ≤ z})
...
EvoSuite's assertion generation~\cite{fraser_2013_evosuite} adds regression assertions
