...
Oracle inference techniques ---
whether regression-based~\cite{fraser_2015_oracle}
or neural~\cite{dinella_2022_toga,hossain_2024_togll,primbs_2025_assert5} ---
add assertions to tests that lack them.
Both expand the pool of tests available for generalization.
...
that must be tackled to support use cases
beyond fully automated testing scenarios.
