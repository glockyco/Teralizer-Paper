...
\ToolSPF{} only encodes constraints for types with adequate solver support.
...
\subsection{Test Generation and Developer Perspective}
...
that should be tackled in future work to better support use cases
