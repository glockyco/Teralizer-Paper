...
it also affects test suite characteristics in three measurable ways:
...
whether added tests can be compensated by test removals,
explaining why \ToolEvoSuite{} generated test suites achieve near-complete compensation
while the developer written test suite in \DatasetCommonsDev{} sees no test removals.
Section~\ref{sec:test-suite-line-count} documents
how current constraint encoding and test isolation implementations affect lines of code,
...
copying setup/teardown methods, helper functions, and class fields
from original test classes.
