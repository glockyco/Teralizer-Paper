...
As previously discussed in Section~\ref{sec:overall-detection-rates},
\VariantNaive{} test suite variants
...
the \VariantImproved{} generalization strategy
encodes simple in-/equalities on numeric and boolean variables or constants during input value generation.
...
that are more capable than those provided by jqwik.
