...
\VariantNaive{} variants consistently
outperform \VariantImproved{}
on \DatasetsEqBenchEs{} projects.
...
while tracking what percentage of constraints \VariantImproved{} can encode
...
\VariantImproved{} can encode the simple comparison \texttt{a < 0} and the boolean variable \texttt{c},
but cannot encode \texttt{a == (b + 1)} because it contains the compound term \texttt{b + 1}.
Thus, \VariantImproved{} uses 2 of 3 total constraints (66.7\% utilization),
...
Undetected mutants consistently have more complex models than detected ones
across all projects.
...
thus enabling more effective guided input generation.
...
applying boundary-focused generation where it provides the largest benefit.
