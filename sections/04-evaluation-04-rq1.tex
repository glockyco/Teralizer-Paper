...
while \VariantImproved{} better detects most other mutation types
...
\texttt{Math} detection similarly benefits from a more diverse
range of tested inputs because arithmetic operations often produce
...
These already achieve high detection rates in the \VariantInitial{} variant (87.87--98.77\%)
