...
the first semantics-based approach that achieves fully automated transformation
...
\textbf{First fully automated semantics-based test generalization.}
Unlike prior approaches such as JARVIS that rely on manually curated constraint templates,
\ToolTeralizer{} achieves complete automation by extracting exact path specifications
