...
Our evaluation results demonstrate that
...
can further improve the effectiveness, efficiency, and applicability
of semantics-based test generalization approaches (Section~\ref{sec:how-to-improve}).
...
As shown by RQ6, generalization fails
...
These factors are beyond the control of the generalization approach itself
but still account for 128 direct project-level exclusions (20.3\% of projects).
...
the specification extraction stage.
