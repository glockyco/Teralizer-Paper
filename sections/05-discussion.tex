...
what causes the gap between controlled and real-world conditions,
...
Approximately 50\% of assertions generalize under controlled conditions,
...
\DatasetsEqBenchEs{} represents controlled conditions with generated tests and numeric focus,
\DatasetsCommons{} introduces real-world complexity while maintaining some controlled characteristics,
...
under controlled conditions, yet only 0.9\% of real-world projects successfully complete processing.
...
The increase from 15.4\% parameter type exclusions in controlled conditions
