...
The following engineering improvements to our prototype implementation
could substantially enhance practical applicability of the approach
without requiring fundamental research advances:
...
The following limitations reflect fundamental challenges in the semantics-based test generalization approach,
requiring research advances rather than engineering improvements:

\subsubsection{Type Support Remains a Research Challenge}

The restriction to numeric and boolean types stems from the difficulty
of representing and solving constraints over non-numeric types, not implementation choices.
...
highlights specification extraction and type support as fundamental research challenges
for semantics-based test generalization, not merely implementation limitations.
