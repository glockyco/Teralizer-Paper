...
RQ4 examines the runtime costs and efficiency of test generalization compared to test generation via \ToolEvoSuite{}.
...
and our evaluation results (Sections~\ref{sec:primary-effects-eval}--\ref{sec:limitations-eval-extended})
provide the necessary data to answer RQ1-RQ6.
