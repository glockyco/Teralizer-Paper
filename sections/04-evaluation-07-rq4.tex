...
Our evaluation of runtime requirements across the five processing stages reveals
that test suite reduction via mutation testing
dominates the overall computational cost of \ToolTeralizer{}'s processing pipeline.
...
than the costs of the preceeding generalization stages
...
from a total of 21,478 to 1,555 across all projects and test suite variants
