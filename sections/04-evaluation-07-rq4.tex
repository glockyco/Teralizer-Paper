...
\VariantShared{} processing stages (i.e., Stages~1--3)
were executed only once per project by \ToolTeralizer{},
with specifications reused across all seven generalization strategies.
...
achieves better detection-to-runtime ratios than simply running \ToolEvoSuite{} with higher search budgets
...
for both the \VariantOriginal{} as well as the generalized test suites.
In our evaluation, mutation testing of the \VariantOriginal{} test suite takes,
on average, 8$\times$ as much runtime
...
The small remainder of the Stage 5 runtime costs falls to the
