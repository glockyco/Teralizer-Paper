...
In contrast, Stages 1 + 2~(project analysis) require only ... seconds (...--...\%),
Stage~3 (specification extraction) requires ... seconds (...),
and Stage~4 (generalized test creation) requires ... seconds (...).
...
The small remainder of the the Stage 5 runtime costs falls to
