\subsection{RQ3: Runtime Costs and Effiency}
...
% \ToolTeralizer{} requires 3.4--30.9 hours total runtime per project,
% with validation consuming 40--78\% of processing time
% while core generalization (specification extraction and transformation) takes less than 10\%.
% Despite high absolute costs,
% combining \ToolEvoSuite{} generation with \ToolTeralizer{} generalization
% achieves better detection-to-runtime ratios than simply increasing \ToolEvoSuite{} search budgets
% in several configurations.
% The efficiency gains stem from their complementary optimization targets:
% \ToolEvoSuite{} optimizes for breadth (coverage)
% while \ToolTeralizer{} optimizes for depth (thorough testing of discovered paths).
% Runtime optimization should focus on validation efficiency
% rather than core generalization logic.
% \end{minipage}}
% \end{center}
