...
(Sections~\ref{sec:test-analysis} and \ref{sec:all-filtering}).
...
The extended evaluation reveals that real-world deployment faces challenges
...
The consistent generalization-level failure rate (10\%)
and systematic filtering patterns across both evaluations
indicate that the core generalization approach remains sound.
...
The dramatic difference between favorable (50\%) and real-world (0.9\%) success rates
underscores that practical deployment requires addressing both
