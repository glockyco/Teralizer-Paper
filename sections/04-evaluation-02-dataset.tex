...
representing ideal conditions for specification extraction, utility methods extracted from Apache Commons projects to bridge
...
This search yielded 247 classes from 106 source files spread across [number] Apache Commons projects,
...
Projects needed to use Java 5--8 (for \ToolSPF{} compatibility),
