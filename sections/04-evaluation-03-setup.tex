...
\begin{itemize}
  \item \VariantOriginal{}: The project before any filtering is applied by \ToolTeralizer{}.
    For \DatasetsEqBenchEs{} and \DatasetsCommonsEs{}, this project variant uses a test suite consisting of \ToolEvoSuite{}-generated tests.
  ...
  \item \VariantInitial{}: The project after instrumentation, test analysis, and specification extraction
    ...
    i.e., excluding tests unsuitable for generalization.
