\begin{table}
  \caption{Number of mutants and percentage of detections per mutator in \DatasetsEqBenchEs{} and \DatasetsCommons{} projects.}
  \label{tab:detections-per-mutator}
  \begin{tabular}{lrrrrcrrrr}
    \toprule
    & & & & & \multicolumn{5}{c}{Detected \%} \\
    \cmidrule{6-10}
    Mutator & Total & Total \% & Min \% & Max \% & \VariantInitial{} & \multicolumn{2}{c}{\VariantNaiveC{}} & \multicolumn{2}{c}{\VariantImprovedC{}} \\
    \midrule
