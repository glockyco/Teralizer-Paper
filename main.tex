...
we used \toolEvoSuite{} to generate test suites
that can be used as input for the generalization.
We chose \toolEvoSuite{} for test generation
...
for \toolEvoSuite{} to approximate different strengths of test suites:
60 seconds per class (\toolEvoSuite{}'s default), 10 seconds per class, and 1 second per class.
All other configuration settings were left at \toolEvoSuite{}'s default values. We refer to
the corresponding projects consisting of \DatasetEqBench{} implementation code and
\toolEvoSuite{} generated test code as \textit{\DatasetEqBenchA{}}, \textit{\DatasetEqBenchB{}}, and \textit{\DatasetEqBenchC{}}.
...
\subsubsection{Additional Open Source Software Projects}
\label{sec:additional-oss-projects}

To get a more representative view of current limitations and directions for future
extensions of the approach, we additionally applied Teralizer to <number> projects
from the <reference> dataset for RQ4. Filter criteria: Java projects that (i) use Java 1.5
to 1.8 (ii) use JUnit 4 or 5, (iii) use Maven, (iv) have 5000-50000 LOC, (v) have
20\%-80\% of the code in test classes (vi) follow the expected folder structure,
i.e., have implementation in src/main/java and tests in src/test/java (vii) have
a total repository size less than 100MB. 
...
\begin{table}[H]
  ...
  \begin{tabular}{lrrrrrrr}
    ...
    \midrule
    rq4-oss-projects (total) & 79,789 & 96,589 & 5,203,516 & 40,872 & 55,038 & 3,905,071 & 167,046 \\
    rq4-oss-projects (mean) & 68 & 83 & 4,478 & 35 & 47 & 3,360 & 143 \\
    rq4-oss-projects (median) & 51 & 57 & 3,241 & 22 & 26 & 2,053 & 69 \\
    \bottomrule
  \end{tabular}
\end{table}
