...
(\VariantBaseline{},
\VariantNaive{} with 10 / 50 / 200 tries,
and \VariantImproved{} with 10 / 50 / 200 tries),
...
achived by the implemented generalization variants.
...
the \VariantBaseline{}, \VariantNaive{} and \VariantImproved{} variants
...
For the \DatasetCommons{} project, 
Further details about the causes of test exclusions
are provided when discussing the results for RQ4 in Section~\ref{sec:filtering-eval}.
...
@TODO: Separate this according to the paragraph structure.
Generalization improves detected mutants for all evaluated projects and generalization variants
(comparison with increasing \ToolEvoSuite{} runtime in Section~\ref{sec:runtime-eval}).
\VariantNaive{} and \VariantImproved{} achieve similar improvements,
with \VariantNaive{} performing slightly better on the \DatasetEqBench{} projects,
and \VariantImproved{} performing slightly better on \DatasetCommons{} projects.
Using a higher \texttt{tries} setting for jqwik also increases the percentage of detected mutants.
However, there seem to be diminishing returns:
increasing tries from 10 to 50 achieves a larger improvement in mutation scores
than increasing tries from 50 to 200.
In absolute numbers, generalization detects 3 new mutants for commons-utils,
X--Y new mutants for the \DatasetsCommonsEs{} projects,
and X--Y new mutants for the .

@TODO: Extend discussion of mutation score results.
...
\paragraph{Comparison of \VariantNaive{} and \VariantImproved{}}
...
Table \ref{tab:detections-per-mutator} shows the total number of mutants across all projects
for each of the 12 mutators in \ToolPit{}'s \texttt{DEFAULTS} group of mutators.
(Add explanations of the different mutators? Or just a link to the PIT website where mutators are described?)

\paragraph{Prevalence of Mutants}
The three most common mutants are ... (X--Y\% of total mutants across projects), ... (...), and ... (...).
Overall, these make up ... \% of the total mutants.
% @TODO: Put these numbers in perspective? E.g., list how many occur on average per class / method / LOC?
The least common mutants are ... .
Overall, these make up ... \% of the total mutants.
% @TODO: Put these numbers in perspective? E.g., list how many occur on average per class / method / LOC?
(@TODO: Mutations that are more (less) common across the overall dataset
are generally also more (less) common in the individual projects.
The largest differences in mutation prevalance can be observed for ... .)

\paragraph{Detection Rate Results}
Detection rates for \VariantInitial{}, \VariantNaiveC{}, and \VariantImprovedC{} as well as
detection rate improvements compared \VariantInitial{}
...
Results for the 10 / 50 \texttt{tries} variants of \VariantNaive{} and \VariantImproved{}
generally follow the same trends as those for the listed variants with 200 \texttt{tries},
...
the number of \texttt{tries} could, for example,
be increased for the \VariantImproved{} variants
to adjust for the additional \texttt{tries} spent on boundary testing
...
without large increases to the number of executed \texttt{tries}
could perhaps further increase detection rates
while keeping the runtime impact
resulting from a higher number of \texttt{tries} to a minimum.
For a more in-depth evaluation of runtime requirements
across different variants and numbers of \texttt{tries}
...
is \DatasetCommons{} with its developer written test suite.
...
Values for \DatasetCommons{} are very different from
...
when used in the \DatasetCommons{} projects
...
\begin{table}[H]
  ...
  \begin{tabular}{lcrrrrrrr}
    \toprule
            &          &         & \multicolumn{2}{c}{Operations} & \multicolumn{2}{c}{Constraints} & \multicolumn{2}{c}{Constr. Used \%} \\
    \cmidrule(lr){4-5} \cmidrule(lr){6-7} \cmidrule(lr){8-9}
    Project & Detected & Mutants & Mean & Med. & Mean & Med. & Mean & Med. \\
    \midrule
    eqbench-es-default-1s & yes & 11145 & 147 & \phantom{0}9 & \phantom{0}6 & 2 & \phantom{0}47 \% & \phantom{0}80 \% \\
    eqbench-es-default-1s & no & 10347 & 224 & 16 & 11 & 5 & \phantom{0}23 \% & \phantom{0}50 \% \\
    \midrule
    eqbench-es-default-10s & yes & 11658 & 139 & \phantom{0}9 & \phantom{0}6 & 2 & \phantom{0}62 \% & 100 \% \\
    eqbench-es-default-10s & no & 9999 & 231 & 15 & \phantom{0}8 & 2 & \phantom{0}57 \% & 100 \% \\
    \midrule
    eqbench-es-default-60s & yes & 12052 & 137 & \phantom{0}9 & \phantom{0}5 & 2 & \phantom{0}69 \% & 100 \% \\
    eqbench-es-default-60s & no & 9958 & 218 & 11 & \phantom{0}6 & 2 & \phantom{0}67 \% & 100 \% \\
    \midrule
    commons-utils & yes & 4193 & 107 & 11 & \phantom{0}4 & 4 & \phantom{0}25 \% & \phantom{0}75 \% \\
    commons-utils & no & 1022 & 173 & 10 & \phantom{0}4 & 4 & \phantom{0}19 \% & \phantom{0}75 \% \\
    \midrule
    commons-utils-es-default-1s & yes & 4390 & 290 & 15 & \phantom{0}7 & 5 & \phantom{0}43 \% & \phantom{0}84 \% \\
    commons-utils-es-default-1s & no & 3183 & 389 & 45 & 12 & 6 & \phantom{0}11 \% & \phantom{0}50 \% \\
    \midrule
    commons-utils-es-default-10s & yes & 4660 & 467 & 23 & \phantom{0}6 & 5 & \phantom{0}46 \% & \phantom{0}85 \% \\
    commons-utils-es-default-10s & no & 3309 & 507 & 46 & \phantom{0}8 & 6 & \phantom{0}10 \% & \phantom{0}56 \% \\
    \midrule
    commons-utils-es-default-60s & yes & 4821 & 374 & 20 & \phantom{0}6 & 5 & \phantom{0}47 \% & \phantom{0}85 \% \\
    commons-utils-es-default-60s & no & 3288 & 423 & 41 & 10 & 6 & \phantom{0}11 \% & \phantom{0}54 \% \\
    \bottomrule
  \end{tabular}
\end{table}
...
(i) the number of tests in the test suite (presented in Section~\ref{sec:test-suite-test-count}),
(ii) the number of lines of code in the test suite (Section~\ref{sec:test-suite-line-count}),
(iii) the overall execution time of the test suite (Section~\ref{sec:test-suite-execution-time}),
and (iv) the execution time of individual tests (Section\ref{sec:test-execution-time}).
%Results are presented in the following
%Sections~\ref{sec:test-suite-test-count}--\ref{sec:test-execution-time}.
...
\midrule
eqbench-es-default-1s & \VariantNaiveC{} & 4718 & 177 & 177 & 4718 & -- & -- \\
eqbench-es-default-10s & \VariantNaiveC{} & 4875 & 174 & 173 & 4876 & +1 & +0.02 \% \\
eqbench-es-default-60s & \VariantNaiveC{} & 4974 & 174 & 174 & 4974 & -- & -- \\
\midrule
eqbench-es-default-1s & \VariantImprovedC{} & 4718 & 206 & 206 & 4718 & -- & -- \\
eqbench-es-default-10s & \VariantImprovedC{} & 4875 & 211 & 210 & 4876 & +1 & +0.02 \% \\
eqbench-es-default-60s & \VariantImprovedC{} & 4974 & 210 & 210 & 4974 & -- & -- \\
\midrule
commons-utils & \VariantNaiveC{} & 725 & 3 & 0 & 728 & +3 & +0.41 \% \\
commons-utils-es-default-1s & \VariantNaiveC{} & 2481 & 60 & 59 & 2482 & +1 & +0.04 \% \\
commons-utils-es-default-10s & \VariantNaiveC{} & 2738 & 63 & 62 & 2739 & +1 & +0.04 \% \\
commons-utils-es-default-60s & \VariantNaiveC{} & 2735 & 60 & 59 & 2736 & +1 & +0.04 \% \\
\midrule
commons-utils & \VariantImprovedC{} & 725 & 3 & 0 & 728 & +3 & +0.41 \% \\
commons-utils-es-default-1s & \VariantImprovedC{} & 2481 & 69 & 68 & 2482 & +1 & +0.04 \% \\
commons-utils-es-default-10s & \VariantImprovedC{} & 2738 & 70 & 69 & 2739 & +1 & +0.04 \% \\
commons-utils-es-default-60s & \VariantImprovedC{} & 2735 & 75 & 74 & 2736 & +1 & +0.04 \% \\
\bottomrule
\end{tabular}
\end{table}
...
Project & Variant & Before & Added & Removed & After & Delta & Delta \% \\
\midrule
eqbench-es-default-1s & \VariantNaiveC{} & 30989 & 11780 & 1127 & 41642 & +10653 & +34.4 \% \\
eqbench-es-default-10s & \VariantNaiveC{} & 32503 & 11520 & 1061 & 42962 & +10459 & +32.2 \% \\
eqbench-es-default-60s & \VariantNaiveC{} & 33510 & 11623 & 1069 & 44064 & +10554 & +31.5 \% \\
\midrule
eqbench-es-default-1s & \VariantImprovedC{} & 30989 & 19019 & 1302 & 48706 & +17717 & +57.2 \% \\
eqbench-es-default-10s & \VariantImprovedC{} & 32503 & 20353 & 1284 & 51572 & +19069 & +58.7 \% \\
eqbench-es-default-60s & \VariantImprovedC{} & 33510 & 20288 & 1285 & 52513 & +19003 & +56.7 \% \\
\midrule
commons-utils & \VariantNaiveC{} & 8561 & 421 & 0 & 8982 & +421 & +4.9 \% \\
commons-utils-es-default-1s & \VariantNaiveC{} & 16563 & 3733 & 359 & 19937 & +3374 & +20.4 \% \\
commons-utils-es-default-10s & \VariantNaiveC{} & 18124 & 3942 & 379 & 21687 & +3563 & +19.7 \% \\
commons-utils-es-default-60s & \VariantNaiveC{} & 17886 & 3723 & 361 & 21248 & +3362 & +18.8 \% \\
\midrule
commons-utils & \VariantImprovedC{} & 8561 & 457 & 0 & 9018 & +457 & +5.3 \% \\
commons-utils-es-default-1s & \VariantImprovedC{} & 16563 & 5261 & 413 & 21411 & +4848 & +29.3 \% \\
commons-utils-es-default-10s & \VariantImprovedC{} & 18124 & 5423 & 421 & 23126 & +5002 & +27.6 \% \\
commons-utils-es-default-60s & \VariantImprovedC{} & 17886 & 5801 & 452 & 23235 & +5349 & +29.9 \% \\
\bottomrule
\end{tabular}
\end{table}
...
Project & Variant & Before & Added & Removed & After & Delta & Delta \% \\
\midrule
eqbench-es-default-1s & \VariantNaiveC{} & 17.44 & 100.94 & 0.74 & 117.65 & +100.20 & +574.5 \% \\
eqbench-es-default-10s & \VariantNaiveC{} & 16.70 & 106.19 & 0.66 & 122.23 & +105.53 & +632.0 \% \\
eqbench-es-default-60s & \VariantNaiveC{} & 18.21 & 221.07 & 0.76 & 238.52 & +220.31 & +1210.0 \% \\
\midrule
eqbench-es-default-1s & \VariantImprovedC{} & 17.44 & 101.62 & 0.68 & 118.38 & +100.94 & +578.7 \% \\
eqbench-es-default-10s & \VariantImprovedC{} & 16.70 & 139.64 & 0.56 & 155.77 & +139.08 & +832.9 \% \\
eqbench-es-default-60s & \VariantImprovedC{} & 18.21 & 124.68 & 0.69 & 142.20 & +123.99 & +681.0 \% \\
\midrule
commons-utils & \VariantNaiveC{} & 7.95 & 4.54 & 0.00 & 12.48 & +4.54 & +57.1 \% \\
commons-utils-es-default-1s & \VariantNaiveC{} & 4.31 & 114.42 & 0.09 & 118.64 & +114.33 & +2651.5 \% \\
commons-utils-es-default-10s & \VariantNaiveC{} & 7.40 & 148.54 & 0.14 & 155.80 & +148.40 & +2005.2 \% \\
commons-utils-es-default-60s & \VariantNaiveC{} & 6.30 & 122.11 & 0.07 & 128.34 & +122.04 & +1936.2 \% \\
\midrule
commons-utils & \VariantImprovedC{} & 7.95 & 0.74 & 0.00 & 8.69 & +0.74 & +9.4 \% \\
commons-utils-es-default-1s & \VariantImprovedC{} & 4.31 & 29.49 & 0.14 & 33.66 & +29.35 & +680.5 \% \\
commons-utils-es-default-10s & \VariantImprovedC{} & 7.40 & 71.50 & 0.21 & 78.70 & +71.30 & +963.3 \% \\
commons-utils-es-default-60s & \VariantImprovedC{} & 6.30 & 28.07 & 0.08 & 34.29 & +27.99 & +444.1 \% \\
\bottomrule
\end{tabular}
\end{table}

\subsubsection{Execution Time of Individual Tests}
\label{sec:test-execution-time}
