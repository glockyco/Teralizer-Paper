...
\begin{itemize}
  \item RQ1: To which degree does generalization affect the mutation score of the generalized test suites?
  \item RQ2: To which degree does generalization affect the size and runtime of the gneralized test suites?
...
\paragraph{EqBench with EvoSuite Tests}
\paragraph{Apache Commons Utils with EvoSuite Tests}
\paragraph{Apache Commons Utils with Original Tests}
...
\subsection{RQ2: Runtime Requirements}

\paragraph{Setup}
\paragraph{Results}

\subsection{RQ3: Effects on Test Suite Size and Runtime}
