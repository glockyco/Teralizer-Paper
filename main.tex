...
\title{Teralizer: Automated Test Generalization from Example-Based to Property-Based Tests}
...
\input{sections/04-evaluation-02-dataset}
\input{sections/04-evaluation-03-setup}
