...
\newcommand{\toolSPF}{SPF}

\newcommand{\toolEvoSuite}{\textsc{EvoSuite}}
...
we also generated three additional test suites via \toolEvoSuite{}
...
(which use \toolEvoSuite{} generated test suites).
