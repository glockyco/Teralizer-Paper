...
Systematic evaluation across three progressively challenging datasets
identifies current capabilities and limitations of semantics-based test generalization.
On \ToolEvoSuite{}-generated tests, mutation scores improve by 1--4 percentage points,
while mature developer-written tests show minimal benefit (0.05--0.07 percentage points).
Analysis of 632 real-world Java projects quantifies applicability barriers:
only 1.7\% successfully complete the generalization pipeline,
with failures primarily caused by type support limitations of symbolic analysis
as well as static analysis limitations of our current prototype implementation.
