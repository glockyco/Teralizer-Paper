...
\title{Teralizer: Automated Test Generalization from Conventional Unit Tests to Property-Based Tests}
...
We present \ToolTeralizer{}, the first fully automated approach for transforming conventional unit tests into property-based tests.
Unlike prior work requiring manual constraint templates,
\ToolTeralizer{} automatically extracts specifications through single-path symbolic analysis using \ToolSPF{}'s constraint collection mode.
...
We contribute:
(1)~first fully automated test generalization,
