...
Our approach analyzes test assertions to identify tested methods via data flow analysis,
extracts specifications from these methods through single-path symbolic analysis,
and uses these specifications to transform conventional tests into property-based tests.
...
Analysis of 1,160 real-world projects identifies applicability barriers:
