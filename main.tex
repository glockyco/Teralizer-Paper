...
Furthermore, higher \texttt{tries} settings generally achieve
better detection rates than lower \texttt{tries} settings.
However, there seem to be diminishing returns:
increasing \texttt{tries} from 10 to 50
achieves a larger improvement in detection rates
than increasing \texttt{tries} from 50 to 200.
...
However, overall detection rates for \DatasetCommons{}
...
As a result, most or even all \texttt{tries} of the \VariantImprovedA{} variant
