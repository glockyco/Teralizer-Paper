...
Since test generalization via \ToolTeralizer{} does not cause any coverage changes
(see Sections~\ref{sec:naive-generalization} and \ref{sec:improved-generalization}), 
all of the following evaluation results focus only on covered mutants.
