...
mutation scores improve by 1--4 percentage points.
Mature developer-written tests from Apache Commons utilities show only 0.05--0.07 percentage points improvement.
Test generalization in 632 real-world Java projects from RepoReapers highlights applicability barriers:
only 1.7\% complete the generalization pipeline,
...
providing a comprehensive dataset characterizing test generalizability patterns.

Artifacts available at \url{[TODO: URL]}.
\end{abstract}
