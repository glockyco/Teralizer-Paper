...
shows the total number of mutants
across \DatasetsEqBenchEs{} and \DatasetsCommonsEs{} projects
for each of the 12 mutators in \ToolPit{}'s \texttt{DEFAULTS} group of mutators.
The \texttt{Math} mutator replaces operators in arithmetic operations (e.g., ).
\texttt{ConditionalsBoundary} replaces operators in 
...
The three most common mutants are
\texttt{Math} mutants (52.34--62.16\% of total mutants across projects),
\texttt{RemoveConditionalOrderElse} mutants (),
and ... (...).
