...
Evaluation of our test generalization approach requires a dataset consisting of projects for which
(i) the source code of the implementation and corresponding tests is available.
Additionally, included projects
...
Apache Commons projects, and
additional open source projects from the ... dataset.
