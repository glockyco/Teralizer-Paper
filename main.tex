...
mutation testing runtimes could likely be improved significantly
through the use of the pitest accelerator plugin (https://docs.arcmutate.com/docs/accelerator.html),
