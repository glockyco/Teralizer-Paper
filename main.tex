...
from the <reference> dataset. Filter criteria: Java projects that (i) use Java 1.5
...
a total repository size less than 100MB. This evaluation only uses the IMPROVED$_{200}$
...
\begin{table}[H]
  \caption{Filtering results of the extended dataset for tests, assertions, and generalizations by filter and (generalization) variant.}
