...
We present \ToolTeralizer{}, a semantics-based approach that automatically transforms
...
Through systematic evaluation across three progressively challenging datasets,
we establish both the potential and boundaries of automated test generalization.
On \ToolEvoSuite{}-generated tests, mutation scores improve by 1--4 percentage points,
while mature developer tests show minimal gains (0.05--0.07pp).
Analysis of 1,160 real-world projects quantifies applicability barriers:
only 0.9\% complete successfully, with failures being primarily caused by assertion-to-method mapping issues,
type support limitations, and constraint encoding challenges.
Our empirical mapping distinguishes addressable engineering barriers from fundamental research challenges,
providing the research community with a comprehensive dataset characterizing test generalizability patterns
across assertion types, specification complexity, and filtering outcomes.

These results demonstrate feasibility under favorable conditions while identifying
current theoretical and practical limitations of semantics-based test generalization,
providing a foundation for future advances in automated test generalization.
...
\input{sections/04-evaluation-02-framework.tex}
